        ...
        >
          ...
          {!token && (
            <button
              ...
              className="bg-red-800 text-white px-3 py-1 rounded-md hover:bg-red-700 transition-all"
            >
              Login
            </button>
          )}
          ...
          <div className="p-6 border-t border-gray-700">
            {token ? (
              ...
              <button
                ...
                className="bg-red-700 text-white w-full py-2 rounded-md h-10 hover:bg-red-800 transition-all"
              >
                Login
              </button>
            )}
